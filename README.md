...
Make sure the Android Build Support module is installed
Connect a Meta Quest 3 in Developer Mode via USB
Select the Android platform under File > Build Profiles and use Build And Run to deploy to the device
Roadmap
 Set up Unity and Meta Quest 3 development environment
 Import the UR10e robot from its URDF
 Realistic materials and coloring
